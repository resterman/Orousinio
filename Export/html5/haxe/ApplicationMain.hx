...
@:access(openfl.Lib) class ApplicationMain {
	...
	public static function embed (elementName:String, width:Null<Int> = null, height:Null<Int> = null, background:String = null) {
		...
		//loaders.set("assets/img/onButton.png", loader);
		total ++;
		...
		image.src = id;
		//var loader:Loader = new Loader();
		//loaders.set("assets/img/higQuality.png", loader);
		total ++;
		...
		image.src = id;
		//var loader:Loader = new Loader();
		//loaders.set("assets/img/medQuality.png", loader);
		total ++;
		...
		image.src = id;
		//var loader:Loader = new Loader();
		//loaders.set("assets/img/backButton.png", loader);
		total ++;
		...
		image.src = id;
		//var loader:Loader = new Loader();
		//loaders.set("assets/img/menuBackground.png", loader);
		total ++;
		...
		image.src = id;
		//var loader:Loader = new Loader();
		//loaders.set("assets/img/optionsButton.png", loader);
		total ++;
		...
		image.src = id;
		//var loader:Loader = new Loader();
		//loaders.set("assets/img/lowQuality.png", loader);
		total ++;
		...
		image.src = id;
		//var loader:Loader = new Loader();
		//loaders.set("assets/img/playButton.png", loader);
		total ++;
		...
		image.src = id;
		//var loader:Loader = new Loader();
		//loaders.set("assets/img/offButton.png", loader);
		total ++;
