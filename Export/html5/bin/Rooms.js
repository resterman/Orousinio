...
ApplicationMain.embed = $hx_exports.openfl.embed = function(elementName,width,height,background) {
	...
	id = "assets/img/optionsButton.png";
...
ApplicationMain.preloader_onComplete = function(event) {
	...
	if(hasMain) Reflect.callMethod(Main,Reflect.field(Main,"main"),[]); else {
		...
		if(js.Boot.__instanceof(instance,openfl.display.DisplayObject)) openfl.Lib.current.addChild(instance); else {
			haxe.Log.trace("Error: No entry point found",{ fileName : "ApplicationMain.hx", lineNumber : 279, className : "ApplicationMain", methodName : "preloader_onComplete"});
			haxe.Log.trace("If you are using DCE with a static main, you may need to @:keep the function",{ fileName : "ApplicationMain.hx", lineNumber : 280, className : "ApplicationMain", methodName : "preloader_onComplete"});
		}
	}
};
...
var rooms = {};
rooms.Game = function() {
	this.isPlayingBfx = true;
	this.isPlayingSfx = true;
	openfl.display.Sprite.call(this);
	this.sfxs = new haxe.ds.StringMap();
	this.bfxs = new haxe.ds.StringMap();
	this.playingSfxs = new Array();
	this.playingBfxs = new Array();
	this.addEventListener(openfl.events.Event.ADDED_TO_STAGE,$bind(this,this.init));
};
$hxClasses["rooms.Game"] = rooms.Game;
rooms.Game.__name__ = ["rooms","Game"];
rooms.Game.__super__ = openfl.display.Sprite;
rooms.Game.prototype = $extend(openfl.display.Sprite.prototype,{
	init: function(e) {
		this.removeEventListener(openfl.events.Event.ADDED_TO_STAGE,$bind(this,this.init));
		this.screen = new rooms.screens.MainMenu(this);
	...
	,addSfx: function(name,path) {
		this.sfxs.set(name,openfl.Assets.getSound(path));
	}
	,removeSfx: function(name) {
		return this.sfxs.remove(name);
	}
	,addBfx: function(name,path) {
		this.bfxs.set(name,openfl.Assets.getSound(path));
	}
	,removeBfx: function(name) {
		return this.bfxs.remove(name);
	}
	,playSfx: function(name) {
		var sound = this.sfxs.get(name);
		if(this.isPlayingSfx) {
			var soundChannel = sound.play();
			soundChannel.addEventListener(openfl.events.Event.SOUND_COMPLETE,$bind(this,this.onSfxEnd));
			this.playingSfxs.push(soundChannel);
		}
	}
	,playBfx: function(name) {
		var sound = this.bfxs.get(name);
		if(this.isPlayingBfx) {
			var soundChannel = sound.play();
			soundChannel.addEventListener(openfl.events.Event.SOUND_COMPLETE,$bind(this,this.onBfxEnd));
			this.playingBfxs.push(soundChannel);
		}
	}
	,onSfxEnd: function(e) {
		e.currentTarget.removeEventListener(openfl.events.Event.SOUND_COMPLETE,$bind(this,this.onSfxEnd));
		var x = e.currentTarget;
		HxOverrides.remove(this.playingSfxs,x);
	}
	,onBfxEnd: function(e) {
		e.currentTarget.removeEventListener(openfl.events.Event.SOUND_COMPLETE,$bind(this,this.onBfxEnd));
		var x = e.currentTarget;
		HxOverrides.remove(this.playingBfxs,x);
	}
	,muteSfx: function() {
		var _g = 0;
		var _g1 = this.playingSfxs;
		while(_g < _g1.length) {
			var sfx = _g1[_g];
			++_g;
			sfx.get_soundTransform().volume = 0;
		}
	}
	,unmuteSfx: function() {
		var _g = 0;
		...
		while(_g < _g1.length) {
			var sfx = _g1[_g];
			++_g;
			sfx.get_soundTransform().volume = 1;
		}
	}
	,muteBfx: function() {
		var _g = 0;
		var _g1 = this.playingBfxs;
		while(_g < _g1.length) {
			var bfx = _g1[_g];
			++_g;
			bfx.get_soundTransform().volume = 0;
		}
	}
	,unmuteBfx: function() {
		var _g = 0;
		...
		while(_g < _g1.length) {
			var bfx = _g1[_g];
			++_g;
			bfx.get_soundTransform().volume = 1;
		}
	}
	,__class__: rooms.Game
});
rooms.screens = {};
rooms.screens.Screen = function(game) {
	openfl.display.Sprite.call(this);
	this.game = game;
};
$hxClasses["rooms.screens.Screen"] = rooms.screens.Screen;
rooms.screens.Screen.__name__ = ["rooms","screens","Screen"];
rooms.screens.Screen.__super__ = openfl.display.Sprite;
rooms.screens.Screen.prototype = $extend(openfl.display.Sprite.prototype,{
	__class__: rooms.screens.Screen
});
rooms.screens.MainMenu = function(game) {
	rooms.screens.Screen.call(this,game);
	this.addEventListener(openfl.events.Event.ADDED_TO_STAGE,$bind(this,this.init));
};
$hxClasses["rooms.screens.MainMenu"] = rooms.screens.MainMenu;
rooms.screens.MainMenu.__name__ = ["rooms","screens","MainMenu"];
rooms.screens.MainMenu.__super__ = rooms.screens.Screen;
rooms.screens.MainMenu.prototype = $extend(rooms.screens.Screen.prototype,{
	init: function(e) {
		this.removeEventListener(openfl.events.Event.ADDED_TO_STAGE,$bind(this,this.init));
		this.drawBackground();
	...
	,drawBackground: function() {
		this.addChild(new openfl.display.Bitmap(openfl.Assets.getBitmapData("assets/img/menuBackground.png")));
	}
	...
	,drawPlayButton: function() {
		var bmpData = openfl.Assets.getBitmapData("assets/img/playButton.png");
		var bmp = new openfl.display.Bitmap(bmpData);
		this.playButton = new openfl.display.Sprite();
		this.playButton.addChild(bmp);
		this.playButton.set_x((this.stage.stageWidth - this.playButton.get_width()) / 2);
		this.playButton.set_y(400);
		this.addChild(this.playButton);
		this.playButton.addEventListener(openfl.events.MouseEvent.CLICK,$bind(this,this.showUpgradeMenu));
	}
	,drawOptionsButton: function() {
		var bmpData = openfl.Assets.getBitmapData("assets/img/optionsButton.png");
		var bmp = new openfl.display.Bitmap(bmpData);
		this.optionsButton = new openfl.display.Sprite();
		this.optionsButton.addChild(bmp);
		this.optionsButton.set_x((this.stage.stageWidth - this.playButton.get_width()) / 2);
		this.optionsButton.set_y(460);
		this.addChild(this.optionsButton);
		this.optionsButton.addEventListener(openfl.events.MouseEvent.CLICK,$bind(this,this.showOptionsMenu));
	}
	,destroyScreen: function() {
		this.playButton.removeEventListener(openfl.events.MouseEvent.CLICK,$bind(this,this.showUpgradeMenu));
		this.playButton = null;
		this.optionsButton.removeEventListener(openfl.events.MouseEvent.CLICK,$bind(this,this.showOptionsMenu));
		this.optionsButton = null;
	}
	,showOptionsMenu: function(e) {
		this.destroyScreen();
		this.game.changeScreen(new rooms.screens.OptionsMenu(this.game));
	}
	,showUpgradeMenu: function(e) {
		this.destroyScreen();
		this.game.changeScreen(new rooms.screens.UpgradeMenu(this.game));
	}
	,__class__: rooms.screens.MainMenu
});
rooms.screens.OptionsMenu = function(game) {
	rooms.screens.Screen.call(this,game);
	this.addEventListener(openfl.events.Event.ADDED_TO_STAGE,$bind(this,this.init));
};
$hxClasses["rooms.screens.OptionsMenu"] = rooms.screens.OptionsMenu;
rooms.screens.OptionsMenu.__name__ = ["rooms","screens","OptionsMenu"];
rooms.screens.OptionsMenu.__super__ = rooms.screens.Screen;
rooms.screens.OptionsMenu.prototype = $extend(rooms.screens.Screen.prototype,{
	init: function(e) {
		this.removeEventListener(openfl.events.Event.ADDED_TO_STAGE,$bind(this,this.init));
		this.drawBackground();
		this.drawSfxButtons();
	...
	,drawSfxButtons: function() {
		this.sfxOnButton = new openfl.display.Sprite();
		this.sfxOnButton.set_x(450);
		this.sfxOnButton.set_y(350);
		this.sfxOnButton.addChild(new openfl.display.Bitmap(openfl.Assets.getBitmapData("assets/img/onButton.png")));
		this.sfxOnButton.addEventListener(openfl.events.MouseEvent.CLICK,$bind(this,this.enableSfx));
		this.addChild(this.sfxOnButton);
		this.sfxOffButton = new openfl.display.Sprite();
		this.sfxOffButton.set_x(560);
		this.sfxOffButton.set_y(350);
		this.sfxOffButton.addChild(new openfl.display.Bitmap(openfl.Assets.getBitmapData("assets/img/offButton.png")));
		this.sfxOffButton.addEventListener(openfl.events.MouseEvent.CLICK,$bind(this,this.disableSfx));
		this.addChild(this.sfxOffButton);
	}
	,drawMusicButtons: function() {
		this.musicOnButton = new openfl.display.Sprite();
		this.musicOnButton.set_x(200);
		this.musicOnButton.set_y(350);
		this.musicOnButton.addChild(new openfl.display.Bitmap(openfl.Assets.getBitmapData("assets/img/onButton.png")));
		this.musicOnButton.addEventListener(openfl.events.MouseEvent.CLICK,$bind(this,this.enableBfx));
		this.addChild(this.musicOnButton);
		this.musicOffButton = new openfl.display.Sprite();
		this.musicOffButton.set_x(310);
		this.musicOffButton.set_y(350);
		this.musicOffButton.addChild(new openfl.display.Bitmap(openfl.Assets.getBitmapData("assets/img/offButton.png")));
		this.musicOffButton.addEventListener(openfl.events.MouseEvent.CLICK,$bind(this,this.disableBfx));
		this.addChild(this.musicOffButton);
	}
	,drawQualityButtons: function() {
		this.lowQualityButton = new openfl.display.Sprite();
		this.lowQualityButton.addChild(new openfl.display.Bitmap(openfl.Assets.getBitmapData("assets/img/lowQuality.png")));
		this.lowQualityButton.addEventListener(openfl.events.MouseEvent.CLICK,$bind(this,this.setLowQuality));
		this.lowQualityButton.set_x(100);
		this.lowQualityButton.set_y(450);
		this.addChild(this.lowQualityButton);
		this.medQualityButton = new openfl.display.Sprite();
		this.medQualityButton.addChild(new openfl.display.Bitmap(openfl.Assets.getBitmapData("assets/img/medQuality.png")));
		this.medQualityButton.addEventListener(openfl.events.MouseEvent.CLICK,$bind(this,this.setMedQuality));
		this.medQualityButton.set_x(210);
		this.medQualityButton.set_y(450);
		this.addChild(this.medQualityButton);
		this.higQualityButton = new openfl.display.Sprite();
		this.higQualityButton.addChild(new openfl.display.Bitmap(openfl.Assets.getBitmapData("assets/img/higQuality.png")));
		this.higQualityButton.addEventListener(openfl.events.MouseEvent.CLICK,$bind(this,this.setHigQuality));
		this.higQualityButton.set_x(320);
		this.higQualityButton.set_y(450);
		this.addChild(this.higQualityButton);
	}
	,drawBackButton: function() {
		this.backButton = new openfl.display.Sprite();
		this.backButton.addChild(new openfl.display.Bitmap(openfl.Assets.getBitmapData("assets/img/backButton.png")));
		this.backButton.set_x(this.stage.stageWidth - this.backButton.get_width() - 10);
		this.backButton.set_y(this.stage.stageHeight - this.backButton.get_height() - 10);
		this.backButton.addEventListener(openfl.events.MouseEvent.CLICK,$bind(this,this.goBack));
		this.addChild(this.backButton);
	}
	,enableSfx: function(e) {
		this.game.unmuteSfx();
	}
	,disableSfx: function(e) {
		this.game.muteSfx();
	}
	,enableBfx: function(e) {
		this.game.unmuteBfx();
	}
	,disableBfx: function(e) {
		this.game.muteBfx();
	}
	,setLowQuality: function(e) {
		this.stage.quality = "low";
	}
	,setMedQuality: function(e) {
		this.stage.quality = "medium";
	}
	,setHigQuality: function(e) {
		this.stage.quality = "high";
	}
	,goBack: function(e) {
		this.destroy();
		this.game.changeScreen(new rooms.screens.MainMenu(this.game));
	}
	,destroy: function() {
		this.sfxOnButton.removeEventListener(openfl.events.MouseEvent.CLICK,$bind(this,this.enableSfx));
		this.removeChild(this.sfxOnButton);
		this.sfxOffButton.removeEventListener(openfl.events.MouseEvent.CLICK,$bind(this,this.disableSfx));
		this.removeChild(this.sfxOffButton);
		this.musicOnButton.removeEventListener(openfl.events.MouseEvent.CLICK,$bind(this,this.enableBfx));
		this.removeChild(this.musicOnButton);
		this.musicOffButton.removeEventListener(openfl.events.MouseEvent.CLICK,$bind(this,this.disableBfx));
		this.removeChild(this.musicOffButton);
		this.backButton.removeEventListener(openfl.events.MouseEvent.CLICK,$bind(this,this.goBack));
		this.removeChild(this.backButton);
	}
	,__class__: rooms.screens.OptionsMenu
});
rooms.screens.UpgradeMenu = function(game) {
	rooms.screens.Screen.call(this,game);
	this.addEventListener(openfl.events.Event.ADDED_TO_STAGE,$bind(this,this.init));
};
$hxClasses["rooms.screens.UpgradeMenu"] = rooms.screens.UpgradeMenu;
rooms.screens.UpgradeMenu.__name__ = ["rooms","screens","UpgradeMenu"];
rooms.screens.UpgradeMenu.__super__ = rooms.screens.Screen;
rooms.screens.UpgradeMenu.prototype = $extend(rooms.screens.Screen.prototype,{
	init: function(e) {
		this.removeEventListener(openfl.events.Event.ADDED_TO_STAGE,$bind(this,this.init));
	}
	,__class__: rooms.screens.UpgradeMenu
});
var $_, $fid = 0;
...
rooms.screens.MainMenu.MENU_BG_SRC = "assets/img/menuBackground.png";
rooms.screens.MainMenu.PLAY_BUTTON_SRC = "assets/img/playButton.png";
rooms.screens.MainMenu.OPTIONS_BUTTON_SRC = "assets/img/optionsButton.png";
rooms.screens.OptionsMenu.MENU_BG_SRC = "assets/img/menuBackground.png";
rooms.screens.OptionsMenu.ON_BUTTON_SRC = "assets/img/onButton.png";
rooms.screens.OptionsMenu.OFF_BUTTON_SRC = "assets/img/offButton.png";
rooms.screens.OptionsMenu.LOW_QUALITY_BUTTON_SRC = "assets/img/lowQuality.png";
rooms.screens.OptionsMenu.MED_QUALITY_BUTTON_SRC = "assets/img/medQuality.png";
rooms.screens.OptionsMenu.HIG_QUALITY_BUTTON_SRC = "assets/img/higQuality.png";
rooms.screens.OptionsMenu.BACK_BUTTON_SRC = "assets/img/backButton.png";
