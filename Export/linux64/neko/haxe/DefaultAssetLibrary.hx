...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		type.set ("assets/img/tripleShotUpgrade.png", AssetType.IMAGE);
		...
		type.set ("assets/img/achievement.png", AssetType.IMAGE);
		path.set ("assets/img/protectUpgrade.png", "assets/img/protectUpgrade.png");
		type.set ("assets/img/protectUpgrade.png", AssetType.IMAGE);
		path.set ("assets/img/powerUpgrade.png", "assets/img/powerUpgrade.png");
		type.set ("assets/img/powerUpgrade.png", AssetType.IMAGE);
